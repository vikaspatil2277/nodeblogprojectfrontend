...
const HomeCard=()=> {
    ...
    useEffect(() => {
        const fetchData = async () => {
          const main = await axios(`https://vikasnodeblogprojectbackend.onrender.com/api/categories/data`);
          const blog = await axios(`https://vikasnodeblogprojectbackend.onrender.com/api/categories/blog`);
          const latestArticle = await axios(`https://vikasnodeblogprojectbackend.onrender.com/api/categories/latestArticle`);
          const topPosts = await axios(`https://vikasnodeblogprojectbackend.onrender.com/api/categories/topPosts`);
          const latestStories = await axios(`https://vikasnodeblogprojectbackend.onrender.com/api/categories/latestStories`);
                    ...
                    {blog.map((item, index) => (
                        <div className=" boxItem" key={index}>
                            ...
                            <div className="details">
                                ...
                                <Link to={`/details/${item.id}`} className="link" state={{ item }} >
                                    <h4>
                                        {item.title}
                                    </h4>
                                </Link>
            ...
            <section className='articles'>
                ...
                <div className='section2'>
                    ...
                    <div className='randomImage'>
                        <img src="https://www.freewalldownload.com/lake-wallpaper/lake-attractive-rivers-wallpaper-free-download.jpg" alt="" />
                    </div>
